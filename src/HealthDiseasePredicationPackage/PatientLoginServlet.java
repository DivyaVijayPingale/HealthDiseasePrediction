...
public class PatientLoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
			...
			PreparedStatement pstmt=con.prepareStatement("select * from patient_details where Email=? and Password=?");
            ...
            if(rs.next())
            {
            	...
            	GetSet.setGender(gender);
            	GetSet.setAge(age);
            	response.sendRedirect("PatientLoginSuccess.html");
            }
            else
            {
